...
func (p *UserTest) GetAll() ([]*User, error) {
	var users []*User
...
func (p *UserTest) GetByEmail(email string) (*User, error) {
	user := User{
		ID:        1,
		Email:     "admin@example.com",
		FirstName: "Admin",
...
func (u *UserTest) PasswordMatches(hash string, plainText string) (bool, error) {
